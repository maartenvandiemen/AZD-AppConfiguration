...
This repo contains a demo for Azure App Configuration which can be deployed to Azure using the [Azure Developer CLI](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/overview). 
